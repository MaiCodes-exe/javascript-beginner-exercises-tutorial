...
function milk(bottles) {
    ...
    for (let i = bottles ; i > 1; i--){
        if (i == 2){
            console.log("2 bottles of milk on the wall, 2 bottles of milk. Take one down and pass it around, 1 bottles of milk on the wall.");
            console.log("1 bottle of milk on the wall, 1 bottle of milk. Take one down and pass it around, 0 bottles of milk on the wall.");
